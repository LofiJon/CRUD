...
<head>
    ...
    <title>Atualizar lista de usuarios</title>
...
?>
  ...
  <form action="update.php" method="POST">
    ...
    <input type="text" class="form-control" name ="id"  placeholder="O código do nome que você deseja atualizar">
    </div>
    <div class="form-group">
    <label for="nome">Nome</label>
    <input type="text" class="form-control" name ="nome"  placeholder="Digite o novo nome de usuário">
    </div>
  <button type="submit" class="btn btn-success" Value="att">Atualizar</button>
</form>
</div>
</main>
<footer>
